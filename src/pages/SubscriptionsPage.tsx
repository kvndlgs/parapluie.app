            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex justify-center mb-12">
                    <div className="bg-base-50 p-1 rounded-full flex">
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-semibold transition-all ${period === 'monthly'
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-semibold transition-all ${period === 'yearly'
                                ? 'bg-white text-primary-250 shadow'
                                : 'text-base-650'
                                }`}
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                    {pricingTiers.map((tier) => (
                        <div
                            key={tier.name}
                            className={`relative rounded-3xl p-8 md:p-10 border transition-all duration-300 flex flex-col ${tier.featured
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-8 grow">
                                {tier.features.map((feature, index) => (
                                    <li
                                        key={index}
                                        className="flex items-start text-base-650"
                                    >
                                        <CheckIcon />
                                        {feature}
                                    </li>
                ...
                <div className="mt-16 text-center">
                    <p className="text-base-650 text-sm">
                        Paiement sécurisé " Satisfait ou remboursé 30 jours " Support en français
                    </p>
                </div>
            </div>
        </section>
