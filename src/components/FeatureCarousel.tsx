...
import ct1 from "../../assets/mockup/ct1.webp";
import ct from "../../assets/mockup/ct.webp";
...
const features: FeatureSlide[] = [
  {
    ...
    description:
      "Restez sans crainte, Walter est à l'affût, 24 heures sur 24 pour assurer qu'aucun appel ou message suspect ne vous soit transmis.",
  ...
  },
  {
    ...
    description:
      "Notre IA analyse le langage et le contexte pour détecter les tentatives de manipulation, tout en respectant la confidentialité absolue des conversations.",
    image: ct,
  },
];
        ...
        <div className="relative w-full md:w-1/2 flex justify-center items-center perspective-1000">
          ...
          */}
          <div className="relative w-[280px] h-[600px] bg-base-100 rounded-[3rem] p-3 shadow-2xl transform transition-all duration-700 ease-out md:rotate-[-12deg] md:hover:rotate-0 border-[6px] border-base-100 ring-1 ring-white/20">
            ...
            <div className="absolute top-28 -left-[8px] w-[2px] h-8 bg-base-50 rounded-l"></div>{" "}
            {/* Mute switch */}
            <div className="absolute top-40 -left-[8px] w-[2px] h-14 bg-base-50 rounded-l"></div>{" "}
            {/* Volume Up */}
            <div className="absolute top-56 -left-[8px] w-[2px] h-14 bg-base-50 rounded-l"></div>{" "}
            {/* Volume Down */}
            <div className="absolute top-44 -right-[8px] w-[2px] h-20 bg-base-50 rounded-r"></div>{" "}
            {/* Power */}
          </div>
        </div>
