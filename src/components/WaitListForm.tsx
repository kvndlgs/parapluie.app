    ...
    return (
      <div className="text-center py-6 animate-[fadeIn_0.5s_ease-out]">
        ...
        <p className="text-gray-500 mb-6">
          {confirmationText || "Vous êtes maintenant sur la liste d'attente. Nous vous contacterons bientôt."}
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" name="waitlist">
      <div className="text-sm text-base-650 mb-4">
        {formText || "Soyez parmi les premiers à protéger vos proches avec Parapluie."}
      </div>
