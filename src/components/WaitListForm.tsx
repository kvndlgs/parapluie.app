...
import { useEffect } from "react"; // useState not needed here
...
// Fix 1: Return type should be JSX.Element (or React.ReactNode)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" name="waitlist">
      <div className="text-sm text-base-650 mb-4">
        {formText ||
          "Soyez parmi les premiers à protéger vos proches avec Parapluie."}
      </div>
      ...
      <div>
        ...
        >
          Nom complet{" "}
          <small className="text-xs text-base-250">Non-requis</small>
        </label>
        <input
          type="text"
          id="fullName"
