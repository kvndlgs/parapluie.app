...
- App Router: Uses the new Next.js App Router (app directory) for routing and layouts
- Server Components: Components are Server Components by default
- Path Aliases: `@/*` points to the project root for clean imports
- Font Optimization: Automatic font optimization using next/font/google
