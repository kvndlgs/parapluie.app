  ...
  if (state.succeeded) {
    return (
      <div className="text-center py-6 animate-[fadeIn_0.5s_ease-out]">
        <h3 className="text-2xl font-bold text-base-600 mb-2">
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://parapluie.app/support/contact" />
      </Head>{" "}
      <section className="pb-16 w-full">
        <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-base-50 to-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-base-600 mb-6">
              {" "}
              Via courriel
            </h2>
            <a href="mailto:bonjour@parapluie.app">
              <h2 className="text-2xl md:text-4xl text-base-500 underline underline-offset-6 mb-6 max-w-full px-4">
        ...
        <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-base-50 to-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" name="waitlist">
            <div>
              <label
                htmlFor="fullName"
                className="block text-sm font-medium text-base-650 mb-1"
              >
