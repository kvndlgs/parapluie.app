...
import { Handshake, ShieldCheck, TrendingUp, Users } from "lucide-react"; // Assuming you use lucide-react, or swap for icons you have
  ...
  const perks = [
    {
      ...
      title: "Impact Social",
      description:
        "Protégez concrètement les membres les plus vulnérables de votre communauté.",
    },
    {
      icon: <TrendingUp className="w-6 h-6 text-primary-300" />,
      title: "Croissance",
      description:
        "Bénéficiez de commissions attractives pour chaque nouvel abonné protégé.",
    },
    {
      icon: <Users className="w-6 h-6 text-primary-300" />,
      title: "Outils Dédiés",
      description:
        "Accédez à des ressources marketing et un tableau de bord pour suivre votre impact.",
    },
  ];
      ...
      <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-primary-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl tbg-base-600 mb-10 max-w-2xl mx-auto">
            Vous accompagnez des seniors ou leur famille ? Devenez partenaire
            Parapluie et offrez-leur la tranquillité d'esprit qu'ils méritent.
          </p>
          <button
            onClick={openModal}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {perks.map((perk, index) => (
              <div
                key={index}
                className="p-8 border border-base-100 rounded-md bg-base-50"
              >
                <div className="mb-4 p-3 bg-white inline-block rounded-md">
                  {perk.icon}
                </div>
                <h3 className="text-xl font-bold text-base-750 mb-2">
                  {perk.title}
                </h3>
      ...
      <section className="py-20 px-6 bg-primary-300 text-white rounded-3xl mx-4 mb-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-800 italic">
            "La fraude ciblant les aînés a augmenté de plus de 300% en deux ans.
            Les solutions actuelles sont passives ; Parapluie est proactif. Nous
            avons besoin de partenaires de confiance pour diffuser cette
            protection."
          </p>
