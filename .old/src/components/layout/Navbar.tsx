    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          ...
          <Link to="/" className="flex items-center justify-center bg-primary rounded-md border-b-2 border-primary-900">
           <ShinyText text="Early Access" speed={3} className="py-3 px-6" />
          </Link> 
        </nav>
